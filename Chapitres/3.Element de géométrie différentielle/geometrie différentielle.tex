...
\begin{theoremframe}
    ...
    \end{notat}
\end{theoremframe}
La définition précise d'un espace tangent sera donné après avoir introduit rigoureusement la notion de variété différentielle. Les éléments de $T_P\mathcal{M}$ sont appelés \textit{vecteurs} au point $P$. 
\begin{rmk}
...
\begin{proof}
    ...
    \begin{equation}
        \mathrm{e}_{\alpha'} = \Lambda\indices{_{\alpha'}^{\mu}}\, \mathrm{e}_{\mu}
    \end{equation}
\end{proof}
...
Nous invitons le lecteur à considérer le chapitre 6 de Nakahara.
\section*{Références}
