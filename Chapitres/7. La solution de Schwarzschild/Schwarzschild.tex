...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{Chapitres/7. La solution de Schwarzschild/Images/orbites newtoniens.png}
    \caption{Représentation du potentiels pour de différentes valeurs d'énergie.}
