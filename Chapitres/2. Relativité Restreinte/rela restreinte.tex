...
\end{align}
Ce qu'on a gagné, c'est que $(T,R)$ ne vont plus jusqu'à l'infini, tout en conservant la structure causal (en vertu d'être relié par une transformation conforme). On a clairement obtenu toutes les conditions qu'on avait énoncées. 
\begin{rmk}
