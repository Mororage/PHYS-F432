...
L'importance des p-formes différentielles réside notamment dans le fait qu'elles peuvent être intégrées et différenciées sans requérir plus de structure géométrique\footnote{Voir par exemple Carroll ou Nakahara.}. Elles permettent aussi de reformuler certaines lois physiques de manière tensorielle et compacte. Pour un champ de p-formes $\Omega^p$ (donnée d'une p-forme en tout point de la variété), on définit l'opérateur différentiel suivant :
\begin{theoremframe}
    \begin{defi}
